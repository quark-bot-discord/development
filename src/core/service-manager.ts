...
export class ServiceManager {
  ...
  /**
   * Legacy method for getting service dependencies from definitions.
   * 
   * @deprecated Use getServiceDependencies instead
   * @param serviceName - The service name to analyze
